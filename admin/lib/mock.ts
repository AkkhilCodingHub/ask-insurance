...
export const USERS: AdminUser[] = [
  { id: "usr-001", name: "Akkhil Sharma",   phone: "9876543210", email: "akkhil@email.com",   dob: "15/08/1995", joinedAt: "Jan 05, 2025", status: "Verified", policyCount: 2, claimCount: 1, premiumTotal: "₹20,000", city: "Mumbai" },
...
export const POLICIES: AdminPolicy[] = [
  { id: "pol-001", policyNo: "ASK-LF-2025-001", userId: "usr-001", userName: "Akkhil Sharma", userPhone: "9876543210", planId: "lic-tech-term",        planName: "LIC Tech Term",                insurer: "LIC of India",   category: "Life",   premium: "₹8,200",  premiumRaw: 8200,  cover: "₹1 Crore",  status: "Active",    startDate: "Jan 10, 2025", renewalDate: "Jan 10, 2026", color: "#1580FF" },
  { id: "pol-002", policyNo: "ASK-HL-2025-002", userId: "usr-001", userName: "Akkhil Sharma", userPhone: "9876543210", planId: "icici-complete-health", planName: "ICICI Complete Health",         insurer: "ICICI Lombard",  category: "Health", premium: "₹11,800", premiumRaw: 11800, cover: "₹5 Lakh",   status: "Active",    startDate: "Jan 10, 2025", renewalDate: "Mar 01, 2026", color: "#7C3AED" },
...
export const CLAIMS: AdminClaim[] = [
  { id: "clm-001", claimNo: "CLM-2025-001", userId: "usr-001", userName: "Akkhil Sharma", userPhone: "9876543210", policyId: "pol-002", insurer: "ICICI Lombard", planName: "ICICI Complete Health",      category: "Health", description: "Hospitalisation — Surgery",         amount: 45000,  filedDate: "Jan 10, 2025", status: "Settled",      adjuster: "Priya Sharma", notes: "Approved after document verification. Surgery receipts valid.", documents: ["Discharge summary", "Hospital bills", "Lab reports"], color: "#7C3AED" },
  { id: "clm-002", claimNo: "CLM-2025-002", userId: "usr-001", userName: "Akkhil Sharma", userPhone: "9876543210", policyId: "pol-002", insurer: "ICICI Lombard", planName: "ICICI Complete Health",      category: "Health", description: "Day-care Procedure",                amount: 12500,  filedDate: "Mar 05, 2025", status: "Approved",     adjuster: "Rahul Verma",  notes: "Day-care procedure claim. Pre-auth obtained.", documents: ["Pre-auth letter", "Bills"], color: "#7C3AED" },
